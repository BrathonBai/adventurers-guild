...
import { AgentMission, AgentMissionPayload, GuildSnapshotRecord, MissionTriggerEvent } from './types';
...
export class MissionEngine {
  ...
  private snapshotProvider?: () => GuildSnapshotRecord;

  setSnapshotProvider(provider: () => GuildSnapshotRecord): void {
